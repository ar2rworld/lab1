...
if (in_array($format, array("jpg", "jpeg", "png", "svg", "txt"))) {
	$file = "qr_".md5($url.$pixel_size.$frame_size).".".$format;	// Assign unique ID filename IF nothing is specified
} else {
	$file = "qr_".md5($url.$pixel_size.$frame_size).".jpg";		// Save as JPEG if the format is malformed
